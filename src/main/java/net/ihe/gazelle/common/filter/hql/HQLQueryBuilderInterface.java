...
public interface HQLQueryBuilderInterface<T> {
	 ...
	 * 
	 * @param items
	 *            List of columns for which we want data. Each column is a path
	 ...
	 * 
	 * @param items
	 *            same items as in getListWithStatistics()
	 * @param item
	 *            an element of the result of getListWithStatistics()
	 * @param statisticItemIndex
	 *            the index of the item for which we want to get the values
	 ...
	 * 
	 * @param maxResults
	 *            Number of results, 10 means 10 items
	 */
