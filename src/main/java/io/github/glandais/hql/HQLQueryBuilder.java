...
import io.github.glandais.hql.paths.HQLSafePath;
import io.github.glandais.hql.restrictions.HQLRestrictions;
...
public class HQLQueryBuilder<T> implements HQLQueryBuilderInterface<T> {
    ...
    private static final Logger log = LoggerFactory.getLogger(HQLQueryBuilder.class);
